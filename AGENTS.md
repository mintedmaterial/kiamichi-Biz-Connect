...
## Custom Agents
Project-specific Codex agents are in `.Codex/agents/` for specialized tasks (API design, Cloudflare Workers, Durable Objects, frontend, GIS/mapping, payments, etc.).
