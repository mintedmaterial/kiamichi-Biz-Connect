/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 5393996c74e8a307d6db68a5a149abab)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		SOCIAL_POST_WORKFLOW: Workflow<Parameters<import("./src/server").SocialPostWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "OPENAI_API_KEY" | "HUGGINGFACE_API_KEY" | "DEEPGRAM_API_KEY" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "ADMIN_KEY" | "GOOGLE_CLIENT_SECRET" | "FACEBOOK_APP_SECRET" | "FB_EMAIL" | "FB_PASSWORD" | "FB_ACCESS_TOKEN">> {}
}
