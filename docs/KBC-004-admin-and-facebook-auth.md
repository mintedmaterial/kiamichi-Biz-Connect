...
- Approval copies that server-validated Page ID into `businesses.facebook_page_id`; downstream Facebook automation must treat that column—not an editable URL—as the Page identity.
