...
-- Generated: 2025-12-12T19:48:43.132Z
-- Total: 51 businesses
...
SELECT
  ...
  'j-c-s-store',
  NULL,
  (SELECT id FROM categories WHERE name = 'Gas Station' LIMIT 1),
  NULL,
  NULL,
  NULL,
  'Valliant, OK 74764',
...
SELECT
  ...
  'rooks-used-cars',
  NULL,
  (SELECT id FROM categories WHERE name = 'Used car dealer' LIMIT 1),
  'Valliant',
  'OK',
  '74764',
  '205 Wilson St',
...
SELECT
  ...
  'curly-s-marine-auto',
  NULL,
  (SELECT id FROM categories WHERE name = 'Boat dealer' LIMIT 1),
  'Millerton',
  'OK',
  '74736',
  '201 E Cherry St',
...
SELECT
  ...
  'kat-s-mobile-truck-repair',
  NULL,
  (SELECT id FROM categories WHERE name = 'Commercial truck repair' LIMIT 1),
  'Spencerville',
  'OK',
  '74760',
  'OK-147',
...
SELECT
  ...
  'hester-s-theatre-of-magic',
  NULL,
  (SELECT id FROM categories WHERE name = 'Theaters & performance venues' LIMIT 1),
  'Broken Bow',
  'OK',
  '74728',
...
SELECT
  ...
  'culpepper-merriweather-circus',
  NULL,
  (SELECT id FROM categories WHERE name = 'Arts & entertainment' LIMIT 1),
  'Hugo',
  'OK',
  '74743',
  '2588 E 2070 Rd',
...
SELECT
  ...
  '6k-ranch',
  NULL,
  (SELECT id FROM categories WHERE name = 'Ranch' LIMIT 1),
  'Valliant',
  'OK',
  '74764',
  '924 N 4490',
...
SELECT
  ...
  'shredz-fitness',
  NULL,
  (SELECT id FROM categories WHERE name = 'Health & Fitness' LIMIT 1),
  'Valliant',
  'OK',
  '74764',
  '514 W Wilson St',
...
SELECT
  ...
  'choctaw-nation-health-clinic',
  NULL,
  (SELECT id FROM categories WHERE name = 'Health & medical' LIMIT 1),
  'Idabel',
  'OK',
  '74745',
  '902 E Lincoln Rd',
...
SELECT
  ...
  'younts-universal-services-llc',
  NULL,
  (SELECT id FROM categories WHERE name = 'Home service' LIMIT 1),
  NULL,
  NULL,
  NULL,
...
SELECT
  ...
  'davis-multi-service-contracting',
  NULL,
  (SELECT id FROM categories WHERE name = 'Handyman' LIMIT 1),
  'Valliant',
  'OK',
  '74764',
  '151 Four Oclock Ln',
...
SELECT
  ...
  'tri-lakes-services',
  NULL,
  (SELECT id FROM categories WHERE name = 'Contractor' LIMIT 1),
  'Valliant',
  'OK',
  '74764',
  '890 Ip Ln',
...
SELECT
  ...
  'velvet-fringe-salon',
  NULL,
  (SELECT id FROM categories WHERE name = 'Beauty & spa' LIMIT 1),
  'Valliant',
  'OK',
  '74764',
  '47 W Wilson St',
...
SELECT
  ...
  'a-salon-vanessa-s-place-hair-salon-barbering',
  NULL,
  (SELECT id FROM categories WHERE name = 'Salons & Spa' LIMIT 1),
  'Broken Bow',
  'OK',
  '74728',
  '809 W Choctaw St',
